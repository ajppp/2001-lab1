...
%\patchcmd{\thebibliography}{\if@openright\cleardoublepage\else\clearpage\fi}{}{}{}
\makeatother
...
\usemintedstyle{vs}       %to format code snippets
 ...
 \usepackage[
    backend=biber,
    style=apa,
    citestyle=apa   ]{biblatex}       %use the biblatex package
...
%\bibliographystyle{}
%\bibliography{references} % Pulls references from references.bib
\newpage
